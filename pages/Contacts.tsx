...
const ContactsPage: React.FC = () => {
    ...
    const filteredContacts = useMemo(() => {
        const byTab = contacts.filter(c => c.type === activeTab);
        ...
        return byTab.filter(c =>
            ...
            c.commercialContact?.name?.toLowerCase().includes(q)
        );
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
                    ...
                    <button onClick={() => { setEditingContact(undefined); setIsModalOpen(true); }} className="px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 whitespace-nowrap">Adicionar Contato</button>
                </div>
            </div>
